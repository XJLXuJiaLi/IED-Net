...
$ python train_seg.py
```
If you want to visualize and save the results during the training process, you can do so by modifying `save_train_freq` and `vis_train_path` in `cfgs/config_seg.yaml`
